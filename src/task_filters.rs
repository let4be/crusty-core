...
pub trait TaskFilter<T: rt::JobContextValues> {
...
impl<T: rt::JobContextValues> TaskFilter<T> for SameDomainTaskFilter {
    fn name(&self) -> &'static str {
        "SameDomainTaskFilter"
    }
    fn accept(&mut self, ctx: &mut rt::StdJobContext<T>, _: usize, task: &rt::Task) -> TaskFilterResult {
...
impl<T: rt::JobContextValues> TaskFilter<T> for PageBudgetTaskFilter {
    fn name(&self) -> &'static str {
        "PageBudgetTaskFilter"
    }
    fn accept(&mut self, _ctx: &mut rt::StdJobContext<T>, _: usize, _: &rt::Task) -> TaskFilterResult {
...
impl<T: rt::JobContextValues> TaskFilter<T> for LinkPerPageBudgetTaskFilter {
    fn name(&self) -> &'static str {
        "LinkPerPageBudgetTaskFilter"
    }
    fn accept(&mut self, _ctx: &mut rt::StdJobContext<T>, seq_num: usize, _: &rt::Task) -> TaskFilterResult {
...
impl<T: rt::JobContextValues> TaskFilter<T> for PageLevelTaskFilter {
    fn name(&self) -> &'static str {
        "PageLevelTaskFilter"
    }
    fn accept(&mut self, _ctx: &mut rt::StdJobContext<T>, _: usize, task: &rt::Task) -> TaskFilterResult {
...
impl<T: rt::JobContextValues> TaskFilter<T> for HashSetDedupTaskFilter {
    fn name(&self) -> &'static str {
